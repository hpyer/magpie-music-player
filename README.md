...
| 插件 | 描述 | 下载 |
| --- | --- | --- |
| Navidrome | 连接 Navidrome 或兼容 Subsonic API 的服务，提供远程播放列表和媒体地址解析能力。 | [GitHub](https://raw.githubusercontent.com/hpyer/magpie-music-player/main/plugins/navidrome/release/cn.hpyer.magpie.navidrome-1.0.0.zip) / [Gitee](https://gitee.com/Hpyer/magpie-music-player/raw/main/plugins/navidrome/release/cn.hpyer.magpie.navidrome-1.0.0.zip) |
